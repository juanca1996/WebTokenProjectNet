...
using DirecTvGo.Providers;
using DirecTvGo.Results;
using System.Net;
using System.Text;
using System.IO;
...
namespace DirecTvGo.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register([FromBody]RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() { UserName = model.Email, Email = model.Email, FirtsNameLastName = model.Name, listphoneuser = model.Phone };

            if (UserManager.FindByEmail(user.Email) != null) {
                IdentityResult validationResult = new IdentityResult("Ya existe un usuario con ese correo");
            ...
            var userCreate = UserManager.FindByEmail(user.Email);

           

            ServiceGetTokenUser service = new ServiceGetTokenUser();
            string token = service.tokenInfo(new UserLogin() { UserEmail = user.Email,UserPassword = model.Password});
